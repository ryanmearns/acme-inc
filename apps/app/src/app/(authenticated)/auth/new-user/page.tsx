      ...
      <Card className="w-[380px] p-4">
        <CardHeader className="text-center space-y-2 items-center">
          ...
          <CardDescription className="text-sm text-muted-foreground">
            Enter your details to finish creating your account or skip.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <NewUserForm />
          <div className="text-sm text-center w-full mt-6 text-muted-foreground flex items-center gap-4">
            <Separator className="grow w-auto" />
            <Link href={"/app/dashboard"}>Skip this step</Link>
            <Separator className="grow w-auto" />
          </div>
        </CardContent>
        <CardFooter>
