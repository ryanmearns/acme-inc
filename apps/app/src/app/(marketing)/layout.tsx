...
export default async function Layout({
  ...
  return (
    <div className="min-h-screen h-full flex flex-col pb-12">
      <div
      ...
      <div className="grow flex min-h-screen flex-col">
        <Navigation />
        <div className="grow flex flex-col">{children}</div>
      </div>
      <Footer />
      <div
        className="absolute bottom-0 inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]"
        aria-hidden="true"
      >
        <div
